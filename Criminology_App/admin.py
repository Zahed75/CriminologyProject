...
from Criminology_App.models import (Home,About, Eventlist, Teacher_Detail, TeacherList,
        ...
        Facilite, Facilites_details,Research_Publication,Seminar_Lab,Computer_Lab,Crime_Lab,Bss_syllabus,Mss_syllabus,Mphil_phd,New_event)
...
class New_eventModelAdmin(SummernoteModelAdmin):  # instead of ModelAdmin
    summernote_fields = '__all__'


admin.site.register(New_event, New_eventModelAdmin)
